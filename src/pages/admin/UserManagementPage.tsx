...
const ROLES = [
  ...
  { role_id: 2, role_name: 'STORE_MANAGER', label: 'Quản lý cửa hàng' },
  { role_id: 3, role_name: 'CHEF', label: 'Bếp trưởng' },
  { role_id: 4, role_name: 'COORDINATOR', label: 'Điều phối' },
] as const;
...
const MOCK_USERS: User[] = [
  {
    ...
    email: 'admin@kitchen.vn',
    role_id: 1,
    is_active: true,
  },
  {
    user_id: 2,
    username: 'store_mgr_1',
    full_name: 'Trần Thị Quản lý',
    email: 'manager@kitchen.vn',
    role_id: 2,
    is_active: true,
  },
  {
    user_id: 3,
    username: 'chef_center',
    full_name: 'Lê Văn Bếp',
    email: 'chef@kitchen.vn',
    role_id: 3,
    is_active: false,
  },
];
...
const UserManagementPage = () => {
  ...
  const getRoleLabel = (roleId: number) => {
    ...
    return role ? `${role.label} (${role.role_name})` : `#${roleId}`;
  };
        ...
        <Card className="border-amber-200/60 bg-white shadow-md">
          ...
          <CardContent className="p-6">
            ...
            {filteredUsers.length === 0 && (
              <p className="py-12 text-center text-amber-600">
      ...
      <Dialog open={deleteConfirmOpen} onOpenChange={setDeleteConfirmOpen}>
        ...
        >
          ...
          <p className="py-4 text-sm text-stone-700">
            ...
            {userToDelete?.username})? Thao tác này không thể hoàn tác.
          </p>
          <DialogFooter>
            <Button
              variant="outline"
